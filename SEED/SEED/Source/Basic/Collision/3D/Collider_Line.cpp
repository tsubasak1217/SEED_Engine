...
namespace SEED{
    ...
    //////////////////////////////////////////////////////////////////
    bool Collider_Line::CheckCollision(const Topology::AABB& aabb){
        return Collision::Line::AABB(body_, aabb);
    }

    bool Collider_Line::CheckCollision(const Topology::OBB& obb){
        return Collision::Line::OBB(body_, obb);
    }


    bool Collider_Line::CheckCollision(const Topology::Sphere& sphere){
    ...
    // 前回のコライダーを破棄
    //////////////////////////////////////////////////////////////////
    void Collider_Line::DiscardPreCollider(){
        UpdateMatrix();
    }
