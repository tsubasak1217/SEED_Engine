...
namespace SEED{
    ...
    public:
        ...
        bool CheckCollision(const Topology::AABB2D& aabb);
    ...
    public:
        Topology::AABB2D GetAABB()const{ return body_; }
        Topology::AABB2D GetPreAABB()const{ return preBody_; }
    ...
    private:
        ...
        Topology::AABB2D local_;
        Topology::AABB2D body_;
        Topology::AABB2D preBody_;
