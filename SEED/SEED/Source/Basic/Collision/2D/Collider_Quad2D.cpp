...
namespace SEED{
    ...
    void Collider_Quad2D::Draw(){
        SEED::Instance::DrawQuad2D(body_);
    }
    ...
    //////////////////////////////////////////////////////////////////
    bool Collider_Quad2D::CheckCollision(const Topology::Circle& circle){
        circle;
        return false;//Collision::Quad2D::Circle(body_, circle);
    }

    bool Collider_Quad2D::CheckCollision(const Topology::Quad2D& quad){
        quad;
