...
namespace SEED{
    ...
    //////////////////////////////////////////////////////////////////
    bool Collider_AABB::CheckCollision(const Topology::AABB& aabb){
        return Collision::AABB::AABB(body_, aabb);
    }

    bool Collider_AABB::CheckCollision(const Topology::OBB& obb){
        return Collision::AABB::OBB(body_, obb);
    }

    bool Collider_AABB::CheckCollision(const Topology::Line& line){
        return Collision::AABB::Line(body_, line);
    }

    bool Collider_AABB::CheckCollision(const Topology::Sphere& sphere){
