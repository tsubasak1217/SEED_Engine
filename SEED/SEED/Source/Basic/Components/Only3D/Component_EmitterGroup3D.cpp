#include "Component_EmitterGroup3D.h"
...
namespace SEED{
    ...
    // コンストラクタ
    //////////////////////////////////////////////////////////////////////////
    Component_EmitterGroup3D::Component_EmitterGroup3D(GameObject* pOwner, const std::string& tagName)
        : IComponent(pOwner, tagName){

        if(tagName == ""){
            componentTag_ = "EmitterGroup3D_ID:" + std::to_string(componentID_);
        }

        // EmitterGroupの生成
        emitterGroup_ = std::make_unique<EmitterGroup3D>(owner_.owner3D->GetWorldMatPtr());
    }
    ...
    // フレーム開始時の処理
    //////////////////////////////////////////////////////////////////////////
    void Component_EmitterGroup3D::BeginFrame(){
    ...
    // 描画処理
    //////////////////////////////////////////////////////////////////////////
    void Component_EmitterGroup3D::Draw(){
    #ifdef _DEBUG
    ...
    // フレーム終了時の処理
    //////////////////////////////////////////////////////////////////////////
    void Component_EmitterGroup3D::EndFrame(){
    }
    ...
    // 終了処理
    //////////////////////////////////////////////////////////////////////////
    void Component_EmitterGroup3D::Finalize(){
    }

    //////////////////////////////////////////////////////////////////////////
    // GUI編集
    //////////////////////////////////////////////////////////////////////////
    void Component_EmitterGroup3D::EditGUI(){
    #ifdef _DEBUG
        ImGui::Indent();
        ...
        if(ImGui::Checkbox("オーナーに親子付けする", &isParentToOwner_)){
            if(isParentToOwner_){
                emitterGroup_->parentMat = owner_.owner3D->GetWorldMatPtr();
            } else{
        ...
        std::string selected = ImFunc::FolderView("ファイルを選択", curPath, { ".emtg3" }, rootPath);

        // 選択されたら読み込み
        if(!selected.empty()){
            nlohmann::json j = Methods::File::GetJson(selected);
    ...
    // Jsonデータの読み込み
    //////////////////////////////////////////////////////////////////////////
    void Component_EmitterGroup3D::LoadFromJson(const nlohmann::json& jsonData){
        ...
        if(jsonData.contains("emitterGroup")){
            emitterGroup_ = std::make_unique<EmitterGroup3D>();
            emitterGroup_->LoadFromJson(jsonData["emitterGroup"]);
            emitterGroup_->parentMat = isParentToOwner_ ? owner_.owner3D->GetWorldMatPtr() : nullptr;
        }
    }
    ...
    // Jsonデータの出力
    //////////////////////////////////////////////////////////////////////////
    nlohmann::json Component_EmitterGroup3D::GetJsonData() const{
        nlohmann::ordered_json jsonData;
        jsonData["componentType"] = "EmitterGroup3D";
