...
namespace SEED{
    ...
    void Collider_AABB2D::UpdateMatrix(){
        ...
        Vector2 scale = Methods::Matrix::ExtractScale(worldMat_);
        float  angle = Methods::Matrix::ExtractRotation(worldMat_);
    ...
    //////////////////////////////////////////////////////////////////
    bool Collider_AABB2D::CheckCollision(const Topology::AABB2D& aabb){
