...
namespace SEED{
    ...
    void PostEffectSystem::CreateResources(){
        ...
        {
            // Resourceの作成
            postEffectResultResource.resource = Methods::DxFunc::InitializeTextureResource(
                DxManager::GetInstance()->GetDevice(),
                SEED::Instance::GetInstance()->kClientWidth_, SEED::Instance::GetInstance()->kClientHeight_,
                DXGI_FORMAT_R8G8B8A8_UNORM_SRGB,
                Methods::DxFunc::STATE_SHADER_RESOURCE
            );
