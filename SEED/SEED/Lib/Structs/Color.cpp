...
namespace SEED{
    ...
    void Color::FromColorCode(uint32_t colorCode, bool isCorrectionToLiner){
        *this = Methods::Math::FloatColor(colorCode, isCorrectionToLiner);
    }

    uint32_t Color::GetColorCode()const{
        return Methods::Math::IntColor(value);
    }

    void Color::FromHSVA(float h, float s, float v, float alpha){
        value = Methods::Math::HSV_to_RGB(h, s, v, alpha);
    }

    void Color::FromHSVA(const Vector4& hsva){
        value = Methods::Math::HSV_to_RGB(hsva);
    }

    Vector4 Color::ToHSVA(){
        return Methods::Math::RGB_to_HSV(value);
    }
    ...
    Vector4 Color::GetGrayScale(bool isCorrectionToLiner){
        return Methods::Math::FloatColor(Methods::Math::GrayScale(Methods::Math::IntColor(value)), isCorrectionToLiner);
    }
