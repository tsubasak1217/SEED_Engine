...
namespace SEED{
    ...
    public:
        ...
        void CreateBuffer(ID3D12Device* device, size_t sizeInBytes, D3D12_RESOURCE_FLAGS resourceFlag){
            gpuBuffer.bufferResource.resource = Methods::DxFunc::CreateBufferResource(device, sizeInBytes, D3D12_HEAP_TYPE_DEFAULT, resourceFlag);
            readbackBuffer.bufferResource.resource = Methods::DxFunc::CreateBufferResource(device, sizeInBytes, D3D12_HEAP_TYPE_READBACK, D3D12_RESOURCE_FLAG_NONE, D3D12_RESOURCE_STATE_COPY_DEST);
