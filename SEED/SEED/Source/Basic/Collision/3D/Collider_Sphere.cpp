...
namespace SEED{
    ...
    //////////////////////////////////////////////////////////////////
    bool Collider_Sphere::CheckCollision(const Topology::AABB& aabb){
        return Collision::Sphere::AABB(body_, aabb);
    }

    bool Collider_Sphere::CheckCollision(const Topology::OBB& obb){
        return Collision::Sphere::OBB(body_, obb);
    }

    bool Collider_Sphere::CheckCollision(const Topology::Line& line){
        return Collision::Sphere::Line(body_, line);
    }

    bool Collider_Sphere::CheckCollision(const Topology::Sphere& sphere){
    ...
    void Collider_Sphere::UpdateBox(){
        ...
        Topology::AABB aabb[2] = {
            Topology::AABB(body_.center,{body_.radius,body_.radius,body_.radius}),
            Topology::AABB(preBody_.center,{preBody_.radius,preBody_.radius,preBody_.radius})
        };
