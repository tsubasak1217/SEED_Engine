...
namespace SEED{
    ...
    D3D12_CPU_DESCRIPTOR_HANDLE DescriptorHeap::GetHeapStartCPU(){
        return Methods::DxFunc::GetCPUDescriptorHandle(descriptorHeap_.Get(), descriptorSize_, 0);
    }

    D3D12_GPU_DESCRIPTOR_HANDLE DescriptorHeap::GetHeapStartGPU(){
        return Methods::DxFunc::GetGPUDescriptorHandle(descriptorHeap_.Get(), descriptorSize_, 0);
    }
