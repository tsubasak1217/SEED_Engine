...
namespace SEED{
            ...
            // スプライト
            {
...

                {
                    ...
                    for(size_t i = 0; i < sprites_.size(); i++){
                        ...
                        // ポインタをハッシュにする
                        std::string ptrStr = Methods::String::PtrToStr(&sprites_[i].second);
            ...
            // テキスト
            {
...

                {
                    ...
                    for(size_t i = 0; i < texts_.size(); i++){
                        ...
                        // ポインタをハッシュにする
                        std::string ptrStr = Methods::String::PtrToStr(&texts_[i].second);
                        std::string ptrHash = "##" + ptrStr;
    ...
    void UIComponent::EditUVScroll(int32_t index){
        ...
        std::string tag = "##" + Methods::String::PtrToStr(&spriteItem);
