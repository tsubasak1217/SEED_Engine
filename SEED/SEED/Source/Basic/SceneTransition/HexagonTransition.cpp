        ...
        if(!isExitScene_){
            ...
            if(curSceneExitTimer_.IsFinishedNow()){
                for(auto& hex : hexagons_){
                    hex.appearTime = Methods::Rand::Random(newSceneEnterTimer_.GetDuration() * 0.1f, newSceneEnterTimer_.GetDuration());
        ...
        for(auto& hex : hexagons_){
            ...
            if(!curSceneExitTimer_.IsFinished()){
                ...
                if(isDraw){
                    ...
                    ease = hex.scalingTimer.GetEase(Methods::Easing::InOut_Quint);
                }
    ...
    void HexagonTransition::CreateHexagonInfo(){
        ...
        while(true){
            ...
            while(currentPos.y < kWindowSize.y){
                ...
                int random = Methods::Rand::Random(0, (int)colorList_.size() - 1);
                ...
                info.appearTime = Methods::Rand::Random(0.0f, curSceneExitTimer_.GetDuration() * 0.9f);
