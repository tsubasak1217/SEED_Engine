...
namespace SEED{
    ...
    void DoF::Initialize(){
        ...
        for(int i = 0; i < 2; i++){
            ...
            // Resourceの作成
            halfTexture_[i].resource = Methods::DxFunc::InitializeTextureResource(
        ...
        // バッファの作成
        blurParamsBuffer_.bufferResource.resource = Methods::DxFunc::CreateBufferResource(GetDevice(), sizeof(BlurParams));
        // Mapする
