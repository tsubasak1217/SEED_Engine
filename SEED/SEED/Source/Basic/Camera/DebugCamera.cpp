...
namespace SEED{
    ...
    void DebugCamera::MoveByPad(){
        ...
        // 移動量の計算
        Vector3 velocity = (moveDirection_ * moveSpeed_) * Methods::Matrix::RotateMatrix({ 0.0f,transform_.rotate.y,0.0f });
    ...
    void DebugCamera::MoveByKeyboard(){
        ...
        // 移動量の計算
        Vector3 velocity = (moveDirection_ * moveSpeed_ * additionalSpeedRate) * Methods::Matrix::RotateMatrix(localEulerRotate);
