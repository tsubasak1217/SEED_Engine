...
namespace SEED{
    ...
    public:// アクセッサ
        ...
        Vector3 GetLocalTranslate()const{ return Methods::Matrix::ExtractTranslation(localMat_); }
        Vector3 GetWorldTranslate()const{ return Methods::Matrix::ExtractTranslation(worldMat_); }
