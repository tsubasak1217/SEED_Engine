...
namespace SEED{
    ...
    void Collider_OBB::UpdateMatrix(){
        ...
        body_.rotate = Methods::Matrix::ExtractRotation(worldMat_);
    ...
    void Collider_OBB::Draw(){
        SEED::Instance::DrawOBB(body_, color_);
    }
    ...
    //////////////////////////////////////////////////////////////////
    bool Collider_OBB::CheckCollision(const Topology::AABB& aabb){
        return Collision::OBB::AABB(body_, aabb);
    }

    bool Collider_OBB::CheckCollision(const Topology::OBB& obb){
        return Collision::OBB::OBB(body_, obb);
    }

    bool Collider_OBB::CheckCollision(const Topology::Line& line){
        return Collision::OBB::Line(body_, line);
    }

    bool Collider_OBB::CheckCollision(const Topology::Sphere& sphere){
    ...
    // 前回のコライダーを破棄
    ////////////////////////////////////////////////////////////////
    void Collider_OBB::DiscardPreCollider(){
        UpdateMatrix();
    }
